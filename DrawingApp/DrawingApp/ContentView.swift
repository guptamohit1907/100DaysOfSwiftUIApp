...
struct ContentView: View {
    ...
    var body: some View{
        Spacer()
        Spirograph(innderRadius: Int(innerRadius), outerRadius: Int(outerRadius), distance: Int(distance), amount: amount)
        ...
        Group{
            ...
            Slider(value: $outerRadius, in : 10...150, step: 1).padding([.horizontal, .bottom])
